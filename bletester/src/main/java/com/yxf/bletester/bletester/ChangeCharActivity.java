package com.yxf.bletester.bletester;
...
import com.yxf.bletester.R;
import com.yxf.bletester.service.BleService;
			...
			if (BleService.ACTION_CHAR_READED.equals(action)) {
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						charString.setText("�ַ���: " + stringValue);
						charHex.setText("ʮ������: " + hexValue);
						time.setText("��ȡʱ��: " + readTime);
			...
			if (BleService.ACTION_DATA_AVAILABLE.equals(action)) {
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						resultcount.setText("�ֽ����� " + resultLength);
					}
				});
			}
			if (BleService.ACTION_GATT_DISCONNECTED.equals(action)) {
				Toast.makeText(ChangeCharActivity.this, "�豸���ӶϿ�",
	...
	public void writeDialog() {
		...
		timing_write.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (writing) {
					timing_write.setText("��ʱ����");
					writing = false;
				} else {
					timing_write.setText("ֹͣ����");
					write_byte_number = 0;
					writing = true;
				}
		...
		case R.id.btn_notify:
			if (!startNotify) {
				bleService.mBluetoothGatt.setCharacteristicNotification(
						gattChar, true);
				startNotify = true;
				notifyButton.setText("ֹ֪ͣͨ");
			} else {
				bleService.mBluetoothGatt.setCharacteristicNotification(
						gattChar, false);
				startNotify = false;
				notifyButton.setText("��ʼ֪ͨ");
			}
			break;
		}
	}
